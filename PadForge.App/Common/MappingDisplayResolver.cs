    ...
    internal static class MappingDisplayResolver
    {
        ...
        internal static string LocalizeObjectName(string name)
        {
            ...
            var localized = name switch
            {
                ...
                "Controller Yaw" => s.VrCtl_Yaw,
                "Controller Pitch" => s.VrCtl_Pitch,
                "Controller Roll" => s.VrCtl_Roll,
                "Controller X" => s.VrCtl_X,
                "Controller Y" => s.VrCtl_Y,
                "Controller Z" => s.VrCtl_Z,
                "Thumbstick X" => s.VrCtl_StickX,
                "Thumbstick Y" => s.VrCtl_StickY,
                "Grip" => s.VrCtl_Grip,
                "Thumbstick Click" => s.VrCtl_StickClick,
                "Primary Button" => s.VrCtl_Primary,
                "Secondary Button" => s.VrCtl_Secondary,
                "Menu Button" => s.VrCtl_Menu,
                "POV" => s.DevObj_POV,
