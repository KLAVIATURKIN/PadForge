...
public class Strings : INotifyPropertyChanged
{
    ...
    public string Settings_GKeys => Get("Settings_GKeys");
    public string Settings_GKeysTooltip => Get("Settings_GKeysTooltip");
    public string Settings_GKeysStatus_NoSdk => Get("Settings_GKeysStatus_NoSdk");
    public string Settings_GKeysStatus_PathStale => Get("Settings_GKeysStatus_PathStale");
    public string Settings_GKeysStatus_LoadFailed => Get("Settings_GKeysStatus_LoadFailed");
    public string Settings_GKeysStatus_WrongLibrary => Get("Settings_GKeysStatus_WrongLibrary");
    ...
    public string Settings_MinimizeToTrayTip => Get("Settings_MinimizeToTrayTip");
    public string Settings_StartMinimizedTip => Get("Settings_StartMinimizedTip");
    public string Settings_StartAtLoginTip => Get("Settings_StartAtLoginTip");
    ...
    public string Settings_Updates => Get("Settings_Updates");
    public string Settings_UpdatesDesc => Get("Settings_UpdatesDesc");
    public string Settings_CheckForUpdates => Get("Settings_CheckForUpdates");
    public string Settings_CheckForUpdatesTip => Get("Settings_CheckForUpdatesTip");
    public string Settings_InstallUpdatesAutomatically => Get("Settings_InstallUpdatesAutomatically");
    public string Settings_InstallUpdatesAutomaticallyTip => Get("Settings_InstallUpdatesAutomaticallyTip");
    public string Settings_IncludePreReleases => Get("Settings_IncludePreReleases");
    public string Settings_IncludePreReleasesTip => Get("Settings_IncludePreReleasesTip");
    public string Settings_CheckNow => Get("Settings_CheckNow");
    public string Settings_InstallAndRestart => Get("Settings_InstallAndRestart");
    public string Settings_ReleaseNotes => Get("Settings_ReleaseNotes");
    public string Update_Checking => Get("Update_Checking");
    public string Update_UpToDate_Format => Get("Update_UpToDate_Format");
    public string Update_Available_Format => Get("Update_Available_Format");
    public string Update_PreReleaseAvailable_Format => Get("Update_PreReleaseAvailable_Format");
    public string Update_AvailableStatusBar_Format => Get("Update_AvailableStatusBar_Format");
    public string Update_Downloading_Format => Get("Update_Downloading_Format");
    public string Update_ReadyNextStart_Format => Get("Update_ReadyNextStart_Format");
    public string Update_CheckFailed_Format => Get("Update_CheckFailed_Format");
    public string Update_RateLimited => Get("Update_RateLimited");
    ...
    public string VrCtl_Yaw => Get("VrCtl_Yaw");
    public string VrCtl_Pitch => Get("VrCtl_Pitch");
    public string VrCtl_Roll => Get("VrCtl_Roll");
    public string VrCtl_X => Get("VrCtl_X");
    public string VrCtl_Y => Get("VrCtl_Y");
    public string VrCtl_Z => Get("VrCtl_Z");
    public string VrCtl_StickX => Get("VrCtl_StickX");
    public string VrCtl_StickY => Get("VrCtl_StickY");
    public string VrCtl_Trigger => Get("VrCtl_Trigger");
    public string VrCtl_Grip => Get("VrCtl_Grip");
    public string VrCtl_StickClick => Get("VrCtl_StickClick");
    public string VrCtl_Primary => Get("VrCtl_Primary");
    public string VrCtl_Secondary => Get("VrCtl_Secondary");
    public string VrCtl_Menu => Get("VrCtl_Menu");
    ...
    public string Dashboard_HeadTrackingAxisRoll => Get("Dashboard_HeadTrackingAxisRoll");
    public string Dashboard_HeadTrackingAxisX => Get("Dashboard_HeadTrackingAxisX");
    public string Dashboard_HeadTrackingAxisY => Get("Dashboard_HeadTrackingAxisY");
    public string Dashboard_HeadTrackingAxisZ => Get("Dashboard_HeadTrackingAxisZ");
    public string Dashboard_HeadTrackingRecenter => Get("Dashboard_HeadTrackingRecenter");
    public string Dashboard_HeadTrackingRecenter_Tooltip => Get("Dashboard_HeadTrackingRecenter_Tooltip");
    ...
    public string About_AntiMicroX => Get("About_AntiMicroX");
    public string About_AntiMicroXDesc => Get("About_AntiMicroXDesc");
    public string About_AudioEndPointLibrary => Get("About_AudioEndPointLibrary");
    public string About_AudioEndPointLibraryDesc => Get("About_AudioEndPointLibraryDesc");
    public string About_AutoEq => Get("About_AutoEq");
    public string About_AutoEqDesc => Get("About_AutoEqDesc");
    public string About_AutoHotkey => Get("About_AutoHotkey");
    public string About_AutoHotkeyDesc => Get("About_AutoHotkeyDesc");
    public string About_CemuhookProtocol => Get("About_CemuhookProtocol");
    public string About_CemuhookProtocolDesc => Get("About_CemuhookProtocolDesc");
    public string About_Ds4Drv => Get("About_Ds4Drv");
    public string About_Ds4DrvDesc => Get("About_Ds4DrvDesc");
    public string About_Ds4MapperTest => Get("About_Ds4MapperTest");
    public string About_Ds4MapperTestDesc => Get("About_Ds4MapperTestDesc");
    public string About_Ds4WindowsHbashton => Get("About_Ds4WindowsHbashton");
    public string About_Ds4WindowsHbashtonDesc => Get("About_Ds4WindowsHbashtonDesc");
    public string About_Ds5Dongle => Get("About_Ds5Dongle");
    public string About_Ds5DongleDesc => Get("About_Ds5DongleDesc");
    public string About_DualSenseSupport => Get("About_DualSenseSupport");
    public string About_DualSenseSupportDesc => Get("About_DualSenseSupportDesc");
    public string About_Eden => Get("About_Eden");
    public string About_EdenDesc => Get("About_EdenDesc");
    public string About_EdRefCard2 => Get("About_EdRefCard2");
    public string About_EdRefCard2Desc => Get("About_EdRefCard2Desc");
    public string About_FFmpeg => Get("About_FFmpeg");
    public string About_FFmpegDesc => Get("About_FFmpegDesc");
    public string About_Fusion => Get("About_Fusion");
    public string About_FusionDesc => Get("About_FusionDesc");
    public string About_GamepadBatteryMonitor => Get("About_GamepadBatteryMonitor");
    ...
    public string About_IconSourcesDesc => Get("About_IconSourcesDesc");
    public string About_IrohFlexInput => Get("About_IrohFlexInput");
    public string About_IrohFlexInputDesc => Get("About_IrohFlexInputDesc");
    public string About_Jc2Mouse => Get("About_Jc2Mouse");
    public string About_Jc2MouseDesc => Get("About_Jc2MouseDesc");
    public string About_LinuxKernel => Get("About_LinuxKernel");
    public string About_LinuxKernelDesc => Get("About_LinuxKernelDesc");
    public string About_GameInput => Get("About_GameInput");
    public string About_GameInputDesc => Get("About_GameInputDesc");
    public string About_VcRuntime => Get("About_VcRuntime");
    public string About_VcRuntimeDesc => Get("About_VcRuntimeDesc");
    public string About_SwitchResearch => Get("About_SwitchResearch");
    public string About_SwitchResearchDesc => Get("About_SwitchResearchDesc");
    public string About_OpenRgb => Get("About_OpenRgb");
    public string About_OpenRgbDesc => Get("About_OpenRgbDesc");
    public string About_OpenTabletDriver => Get("About_OpenTabletDriver");
    public string About_OpenTabletDriverDesc => Get("About_OpenTabletDriverDesc");
    public string About_PcscSharp => Get("About_PcscSharp");
    public string About_PcscSharpDesc => Get("About_PcscSharpDesc");
    public string About_Psmoveapi => Get("About_Psmoveapi");
    public string About_PsmoveapiDesc => Get("About_PsmoveapiDesc");
    public string About_TelemetryRefs => Get("About_TelemetryRefs");
    public string About_TelemetryRefsDesc => Get("About_TelemetryRefsDesc");
    public string About_Ds3Research => Get("About_Ds3Research");
    public string About_Ds3ResearchDesc => Get("About_Ds3ResearchDesc");
    public string About_SipSorcery => Get("About_SipSorcery");
    public string About_SipSorceryDesc => Get("About_SipSorceryDesc");
    public string About_SpaceMouseRefs => Get("About_SpaceMouseRefs");
    public string About_SpaceMouseRefsDesc => Get("About_SpaceMouseRefsDesc");
    public string About_SpecialK => Get("About_SpecialK");
    public string About_SpecialKDesc => Get("About_SpecialKDesc");
    public string About_SteamControllerRefs => Get("About_SteamControllerRefs");
    public string About_SteamControllerRefsDesc => Get("About_SteamControllerRefsDesc");
    public string About_ThumbstickDeadzones => Get("About_ThumbstickDeadzones");
    public string About_ThumbstickDeadzonesDesc => Get("About_ThumbstickDeadzonesDesc");
    public string About_Touchmote => Get("About_Touchmote");
    public string About_TouchmoteDesc => Get("About_TouchmoteDesc");
    public string About_TriggerEffectGenerator => Get("About_TriggerEffectGenerator");
    public string About_TriggerEffectGeneratorDesc => Get("About_TriggerEffectGeneratorDesc");
    public string About_ViGEmClient => Get("About_ViGEmClient");
    public string About_ViGEmClientDesc => Get("About_ViGEmClientDesc");
    public string About_ViiperHbashton => Get("About_ViiperHbashton");
    public string About_ViiperHbashtonDesc => Get("About_ViiperHbashtonDesc");
    public string About_WheelRefs => Get("About_WheelRefs");
    public string About_WheelRefsDesc => Get("About_WheelRefsDesc");
    public string About_WiiBrew => Get("About_WiiBrew");
    public string About_WiiBrewDesc => Get("About_WiiBrewDesc");
    public string About_X1nput => Get("About_X1nput");
    public string About_X1nputDesc => Get("About_X1nputDesc");
}
